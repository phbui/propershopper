...
def main():
    ...
    scripts = ['socket_env.py --keyboard --num_player=5 --mode=999 --stochastic=False --render_number', 
               "astar_path_planner_0.py", 
               "socket_agent_pathplanner.py",
               "group2_socket_final.py", 
               "shopper.py --player_num 3 --player_id 3", 
               "socket_agent_proj.py", 
               ]
